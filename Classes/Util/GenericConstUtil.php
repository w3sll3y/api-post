...
abstract class GenericConstUtil {
  ...
  public const TIPO_GET = ['USUARIOS', 'POSTS', 'LOGIN', 'COMENTARIO'];
  public const TIPO_POST = ['USUARIOS', 'POSTS', 'LOGIN', 'COMENTARIO'];
  public const TIPO_DELETE = ['USUARIOS', 'POSTS', 'LOGIN', 'COMENTARIO'];
  public const TIPO_PUT = ['USUARIOS', 'POSTS', 'LOGIN', 'COMENTARIO'];
